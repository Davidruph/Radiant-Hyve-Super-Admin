      ...
      <div className="grid grid-cols-12">
        <div className="xl:col-span-6 md:col-span-9 col-span-12 bg-white rounded-xl shadow-sm md:px-5 px-3 py-5 xl:mt-0 mt-5">
          <div className="flex items-start gap-1">
            <h4 className="text-[#4B5563] font-semibold md:text-base text-sm whitespace-nowrap">
              Service type :
            </h4>
            <span className="text-[#293FE3] font-medium md:text-base text-sm ">
              Monthly Subscription
            </span>
          </div>
          <div className="flex items-center gap-1 my-3">
            <h4 className="text-[#4B5563] font-semibold md:text-base text-sm">
              Service fee :
            </h4>
          ...
          <p
            ...
            className="text-[#3B4045] font-medium md:text-base text-sm"
          >
            <span className="text-[#4B5563] font-semibold md:text-base text-sm">
              Description :
            </span>{" "}
            Experience the ultimate convenience and exclusive benefits with our
            subscription plans. By subscribing, you gain access to priority
            services, special discounts, and features designed to enhance your
            experience. Enjoy peace of mind with our transparent pricing and the
            ability to cancel at any time. Join now and discover the difference
            a subscription can make to simplify your everyday life!
          </p>
        </div>
      </div>
