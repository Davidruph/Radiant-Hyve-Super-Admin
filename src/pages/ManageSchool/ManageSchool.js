...
import { addSchoolApi, deleteSchoolApi, getSchoolListApi } from '../../services/api_services';
  ...
  return (
    <div>
      <div className='flex sm:flex-row flex-col sm:items-center items-start sm:space-y-0 space-y-2 sy justify-between'>
        <h2 className='text-[#1F1F1F] font-semibold md:text-xl text-lg'>School list</h2>
              ...
              <table className="min-w-full text-sm">
                <thead className="bg-[#F8FAFB] border-b">
                  <tr>
                    ...
                    <th className="p-3 text-center text-[#3B4045] font-medium text-sm whitespace-nowrap">Actions</th>
                  </tr>
                </thead>
                <tbody>
                  {schoolData?.map((school, index) => (
                    <tr key={index} className="hover:bg-gray-50">
                      <td className="min-w-[80px] px-4 py-2 border-b text-[#1F1F1F]">{school?.id}</td>
                          ...
                          <DropdownMenu.Portal>
                            ...
                            >
                              <DropdownMenu.Item
                                ...
                                onClick={() => navigate(`/super_admin/manage_school/school_details/${school.id}`)}
                              >
                              ...
                              <DropdownMenu.Item
                                onClick={() => { setId(school.id); setDeleteModal(true) }}
                                className="cursor-pointer flex items-center gap-3 text-start outline-none px-4 py-3 border-b border-[#E9E9E9] hover:bg-gray-100"
                              >
                                <img src={DeleteIcon} className='w-[24px] h-[24px]' alt='' />
                                <span className='text-[#1F1F1F] font-normal md:text-base text-sm'>Delete</span>
                              </DropdownMenu.Item>
                            </DropdownMenu.Content>
                          </DropdownMenu.Portal>
                        </DropdownMenu.Root>
          ...
          <Dialog.Description className="">
            <div className='md:px-8 md:py-4 p-4'>
              <div className='w-full relative text-center my-3'>
                <h1 className='md:text-lg text-base font-semibold text-[#274372]'>School Information</h1>
                <button className='absolute top-0 right-0' onClick={() => setIsModalOpens(false)}>
              ...
              <form onSubmit={formik.handleSubmit} className="mt-7">
                <div className="md:h-full h-[400px] popupheight overflow-y-auto px-2">
                  <div className="mb-6">
                    <h3 className="text-[#1F1F1F] font-medium text-base mb-4">School Details</h3>
                    ...
                    <div className="mb-4 text-start">
                      ...
                      <input
                        ...
                        className={`w-full border text-sm px-4 py-3 rounded-lg focus:ring-2 focus:outline-none ${formik.touched.schoolName && formik.errors.schoolName
                  ...
                  <div>
                    <h3 className="text-[#1F1F1F] font-medium md:text-lg text-base mb-4">Admin Details</h3>
                    ...
                    <div className="mb-4 text-start">
                      ...
                      <input
                        ...
                        className={`w-full border text-sm px-4 py-3 rounded-lg focus:ring-2 focus:outline-none ${formik.touched.adminEmail && formik.errors.adminEmail
                          ? "border-red-500 focus:ring-red-300"
                          : "border-[#E5E7EB] focus:ring-gray-400"
                          }`}
                      />
            ...
            <div className='md:px-8 px-3 py-5'>
              ...
              <div className='mt-7'>
                ...
                <div className='w-full mt-5 text-center'>
                  ...
                  <p className='text-[#4B5563] font-normal text-base'>This decision is final and cannot be undone.
